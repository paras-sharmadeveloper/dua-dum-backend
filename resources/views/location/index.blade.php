...
@section('scripts')
    <script>
        ...
        const LOCATION_URL = {
            BASE: '/location',
            DATA: "{{ route('location.get-locations') }}",
            GET_ONE: function (id) {
                debugger;
        ...
        function ActionPrivilege(row) {
            var html =
                `<a href="/location/${row.id}/edit"  class="btn btn-sm btn-warning"><i class="fas fa-edit"></i> Edit </a> `;
            return html;
        }
            ...
            showConfirmation("Are You Sure You Want to Create Permission?")
                .then((prompt) => {
                    ...
                    $.ajax({
                        ...
                        url: LOCATION_URL.SAVE_PERMISSION,
                        type: 'POST',
                        data: {
                            name: permissionName
                        },
