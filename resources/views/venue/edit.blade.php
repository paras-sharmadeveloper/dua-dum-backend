                                ...
                                <div class="overflow-hidden flex-grow-1">
                                    <select name="user_id" class="form-select form-select-sm rounded-start-0"
                                        ...
                                        @foreach ($fieldAdmins as $fieldAdmin)
                                            <option value="{{ $fieldAdmin->id }}" {{ $venue->user_id == $fieldAdmin->id ? 'selected' : '' }}>
                                                {{ $fieldAdmin->name }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="input-group input-group-sm flex-nowrap">
                                ...
                                <div class="overflow-hidden flex-grow-1">
                                    <input name="start_date" class="form-control form-control-sm"
                                        placeholder="Pick date & time" id="startDate" value="{{ $venue->start_date }}" required />
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="input-group input-group-sm flex-nowrap">
                                ...
                                <div class="overflow-hidden flex-grow-1">
                                    <input name="end_date" class="form-control form-control-sm"
                                        placeholder="Pick date & time" id="endDate" value="{{ $venue->end_date }}" required />
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="overflow-hidden flex-grow-1">
                                    <select name="location_group_id" class="form-select form-select-sm rounded-start-0"
                                        ...
                                        @foreach ($venueTypes as $venueType)
                                            <option value="{{ $venueType->id }}" {{ $venue->location_group_id == $venueType->id ? 'selected' : '' }}>
                                                {{ $venueType->name }}
                                            </option>
                                        @endforeach
                                    </select>
                    ...
                    <div class="row mb-5">
                        <div class="col-md-3">
                            ...
                            <div class="input-group">
                                <textarea name="venue_address_eng" class="form-control form-control-sm" required>{{ $venue->venue_address_eng }}</textarea>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <label class="d-flex align-items-center fs-7 fw-semibold form-label mb-1">
                            ...
                            <div class="input-group">
                                <textarea name="venue_address_urdu" class="form-control form-control-sm" required>{{ $venue->venue_address_urdu }}</textarea>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <label class="d-flex align-items-center fs-7 fw-semibold form-label mb-1">
                            ...
                            <div class="input-group">
                                <textarea name="status_page_note_eng" class="form-control form-control-sm" required>{{ $venue->status_page_note_eng }}</textarea>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <label class="d-flex align-items-center fs-7 fw-semibold form-label mb-1">
                            ...
                            <div class="input-group">
                                <textarea name="status_page_note_urdu" class="form-control form-control-sm" required>{{ $venue->status_page_note_urdu }}</textarea>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card card-xl-stretch mb-xl-8">
                                <div class="card-body p-0">
                                    ...
                                    <div class="bg-body shadow-sm card-rounded mx-9 mb-9 px-6 py-9 position-relative z-index-1"
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <div class="input-group input-group-xs mb-3" style="width: 80px;">
                                                        <input type="text" name="general_dua_token"
                                                            ...
                                                            id="generalDuaTokens" value="{{ $venue->general_dua_token }}" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="d-flex align-items-center flex-wrap w-100">
                                                <div class="form-check form-check-custom form-check-sm">
                                                    <input class="form-check-input" type="checkbox" value=""
                                                        id="duaCheck" {{ $venue->dua_reason ? 'checked' : '' }} />
                                        ...
                                        <!-- Dua Reason -->
                                        <div class="d-flex align-items-center mb-6 {{ $venue->dua_reason ? '' : 'd-none' }}" id="duaCheckDiv">
                                            <div class="d-flex align-items-center flex-wrap w-100">
                                                <div class="input-group input-group-sm flex-nowrap">
                                                    <div class="overflow-hidden flex-grow-1">
                                                        <select name="dua_reason" class="form-select form-select-sm rounded"
                                                            ...
                                                            <option></option>
                                                            <option value="1" {{ $venue->dua_reason == '1' ? 'selected' : '' }}>Option 1</option>
                                                            <option value="2" {{ $venue->dua_reason == '2' ? 'selected' : '' }}>Option 2</option>
                                                            <option value="3" {{ $venue->dua_reason == '3' ? 'selected' : '' }}>Option 3</option>
                                                            <option value="4" {{ $venue->dua_reason == '4' ? 'selected' : '' }}>Option 4</option>
                                                            <option value="5" {{ $venue->dua_reason == '5' ? 'selected' : '' }}>Option 5</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <div class="input-group input-group-xs mb-3" style="width: 80px;">
                                                        <input type="text" name="general_dum_token"
                                                            class="form-control form-control-sm" placeholder="0"
                                                            id="generalDumTokens" value="{{ $venue->general_dum_token }}" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="d-flex align-items-center mb-6">
                                            <div class="d-flex align-items-center flex-wrap w-100">
                                                <div class="form-check form-check-custom form-check-sm">
                                                    <input class="form-check-input" type="checkbox" value=""
                                                        id="dumCheck" {{ $venue->dum_reason ? 'checked' : '' }} />
                                        ...
                                        <!-- Dum Reason -->
                                        <div class="d-flex align-items-center mb-6 {{ $venue->dum_reason ? '' : 'd-none' }}" id="dumCheckDiv">
                                            <div class="d-flex align-items-center flex-wrap w-100">
                                                <div class="input-group input-group-sm flex-nowrap">
                                                    <div class="overflow-hidden flex-grow-1">
                                                        <select name="dum_reason" class="form-select form-select-sm rounded"
                                                            data-control="select2" data-placeholder="Select Reason">
                                                            <option></option>
                                                            <option value="1" {{ $venue->dum_reason == '1' ? 'selected' : '' }}>Option 1</option>
                                                            <option value="2" {{ $venue->dum_reason == '2' ? 'selected' : '' }}>Option 2</option>
                                                            <option value="3" {{ $venue->dum_reason == '3' ? 'selected' : '' }}>Option 3</option>
                                                            <option value="4" {{ $venue->dum_reason == '4' ? 'selected' : '' }}>Option 4</option>
                                                            <option value="5" {{ $venue->dum_reason == '5' ? 'selected' : '' }}>Option 5</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <div class="input-group input-group-xs mb-3" style="width: 80px;">
                                                        <input type="text" name="working_lady_dua_token"
                                                            class="form-control form-control-sm" placeholder="0"
                                                            id="workingLadyDuaTokens" value="{{ $venue->working_lady_dua_token }}" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#venueForm').on('submit', function (e) {
                ...
                $.ajax({
                    url: '{{ route("venue.update", $venue->id) }}',
                    method: 'PUT',
                    data: $(this).serialize(),
                    ...
                    error: function (xhr) {
                        let errorMessage = 'An error occurred while updating the venue.';
            ...
            // Set initial disabled states based on checkboxes
            if ($('#duaCheck').is(':checked')) {
                $('#generalDuaTokens').prop('disabled', true);
                $('#workingLadyDuaTokens').prop('disabled', true);
            }
            if ($('#dumCheck').is(':checked')) {
                $('#generalDumTokens').prop('disabled', true);
            }
        });
    </script>
